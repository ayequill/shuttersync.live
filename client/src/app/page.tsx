...
export default async function HomePage() {
  ...
  return (
    <main className="grid items-center mx-auto">
      <div className='grid items-center max-w-full justify-center gap-8 lg:gap-20' style={{backgroundImage: 'url(/home.webp)', backgroundPosition: 'center'}}>
        <div className='flex flex-col items-start md:items-center md:text-center w-full justify-start md:justify-center gap-2 backdrop-blur-sm h-full py-10 lg:py-20 px-4'>
        ...
        {/* <div className='flex max-w-lg'>
          <Image src={Home} alt="ShutterSync" />
        </div> */}
      </div>
      ...
      <div className='grid grid-rows-3 gap-1 lg:gap-20 items-center px-2'>
          <div className='flex flex-col sm:flex-row justify-between items-center gap-10 rounded-lg px-5 lg:px-10 py-10 lg:py-2 bg-sky-50 dark:bg-secondary  lg:h-[400px]'>
            <p className='leading-relaxed font-normal text-[1rem] md:text-[24px] md:w-1/2 animate:'>
            Effortlessly organize and showcase your stunning portfolio with ShutterSync intuitive gallery management. Seamlessly upload, arrange, and update your work to create a visual narrative that captivates clients and enhances your professional image.
            </p>
            <Image className='lg:max-w-[400px]' src={MobileInHand} alt='feature'/>
          </div>
          <div className='flex flex-col lg:flex-row justify-between items-center gap-10 rounded-lg px-5 lg:px-10 py-10 lg:py-2 bg-sky-50 dark:bg-secondary text-[1rem] md:text-[1.4rem]'>
